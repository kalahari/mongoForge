...
declare module MongoDb {
    ...
    export class MongoClient {
        ...
        public connect(uri: string, callback: (err: Error, db: Db) => void): void;
        public connect(uri: string): Promise<Db>;
        public connect(uri: string, options: any, callback: (err: Error, db: Db) => void): void;
        public connect(uri: string, options: any): Promise<Db>;
    }
    ...
    export interface IResultListedDatabase {
        name: string;
        sizeOnDisk: number;
        empty: boolean;
    }

    export interface IResultListDatabases extends IResult {
        databases: IResultListedDatabase[];
        totalSize: number;
    }
    ...
    export interface IResultListedCollection {
        name: string;
        options: Object;
    }
    ...
    export class Db {
        ...
        public listCollections(filter?: Object, options?: Object): Cursor<IResultListedCollection>;
    ...
    export interface Collection<T> {
        new (db: Db, collectionName: string, pkFactory?: Object, options?: CollectionCreateOptions): Collection<any>; // is this right?
        /**
        ...
        findOne(callback?: (err: Error, result: any) => void): Cursor<T>;
        findOne(selector: Object, callback?: (err: Error, result: any) => void): Cursor<T>;
        findOne(selector: Object, fields: any, callback?: (err: Error, result: any) => void): Cursor<T>;
        findOne(selector: Object, options: CollectionFindOptions, callback?: (err: Error, result: any) => void): Cursor<T>;
        findOne(selector: Object, fields: any, options: CollectionFindOptions, callback?: (err: Error, result: any) => void): Cursor<T>;
        findOne(selector: Object, fields: any, skip: number, limit: number, callback?: (err: Error, result: any) => void): Cursor<T>;
        findOne(selector: Object, fields: any, skip: number, limit: number, timeout: number, callback?: (err: Error, result: any) => void): Cursor<T>;
    ...
    export class Cursor<T> {
        ...
        toArray(): Promise<T[]>;
        each(callback?: (err: Error, item: T) => void): void;
        ...
        nextObject(callback?: (err: Error, doc: T) => void): void;
